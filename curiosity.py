...
class Topics:
    ...
    def curi_tr_get_html():
        ...
        open('/home/ubuntu/workspace/curiosity-to-vk/curi_rt_html.html', 'a').write(trendings_html)
    ...
    def download_first_img():
        ...
        while count <= max_index:
            ...
            open('/home/ubuntu/workspace/curiosity-to-vk/topics/first-img/'+str(count)+'.png', 'wb').write(resp.body)
            count = count + 1
