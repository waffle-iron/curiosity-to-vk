...
class Curiosity:
    ...
    def img_0_downloader():
        ...
        while count <= max_ind:
            ...
            with open('C:/Users/Елена/PycharmProjects/curiosity-to-vk/topics/zero-img-' + str(count) + '.png',
                      'wb') as zero:
                zero.write(res.content)
            Curiosity.topic_img_0_scr.append(
                '/home/ubuntu/workspac/curiosity-to-v/topics/zero-img-' + str(count) + '.png')
            count = count + 1
    ...
    def translater():
        ...
        while count <= max_index:
            ...
            paragraph_2_text_ru = requests.get('https://translate.yandex.net/api/v1.5/tr.json/translate',
params=paragraph_2_text).json()
    ...
    def img_1_downloader():
        ...
        while count <= max_index:
            ...
            with open('C:/Users/Елена/PycharmProjects/curiosity-to-vk/topics/first-img-' + str(count) + '.png',
                      'wb') as zero:
                zero.write(res.content)
            Curiosity.topic_img_1_scr.append(
                '/home/ubuntu/workspac/curiosity-to-v/topics/first-img-' + str(count) + '.png')
            count = count + 1
    ...
    def img_2_downloader():
        ...
        while count <= max_index:
            try:
                ...
                with open('C:/Users/Елена/PycharmProjects/curiosity-to-vk/topics/two-img-' + str(count) + '.png',
                      'wb') as zero:
                    zero.write(res.content)
    ...
    def img_3_downloader():
        ...
        while count <= max_index:
            try:
                ...
                with open('C:/Users/Елена/PycharmProjects/curiosity-to-vk/topics/-img-' + str(count) + '.png',
                      'wb') as zero:
                    zero.write(res.content)
